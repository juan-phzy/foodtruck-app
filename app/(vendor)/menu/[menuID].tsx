...
export default function EditMenuPage() {
    console.log("\n\napp/(vendor)/menu/[menuID].tsx: Entered File");
    const insets = useSafeAreaInsets();
    const router = useRouter();

    const menuID = useLocalSearchParams().menuID;
    ...
    useEffect(() => {
        if (menu) {
            setMenuName(menu.name || ""); // in case you want to use a menu name
            setCategories(
                menu.menu.map((category) => ({
                    ...
                    items: category.items.map((item) => ({
                        ...
                        price: item.price.toString(), // Convert price (number) to string for TextInput
                    })),
                }))
            );
        }
        ...
        >
            ...
            <ScrollView contentContainerStyle={styles.scrollView}>
                ...
                <StandardButton
                    ...
                    onPress={async () => {
                        try {
                            await deleteMenu({ menuId: menuID as Id<"menus"> });
                            showToast({
                                type: "success",
                                title: "Success",
