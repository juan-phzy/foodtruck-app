...
export default function CreateUserStep4() {
    console.log("");
    console.log("_____________________________________________");
    console.log("app/(auth)/createUser/step4.tsx: Entered Page");
    ...
    const { data } = useUserOnboardingStore();
