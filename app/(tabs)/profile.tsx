...
const achievements = [
  ...
  { id: '2', title: 'The Start of Your Journey!', description: 'Visited your first truck', progress: 55.0 },
  { id: '3', title: 'The Start of Your Journey!', description: 'Visited your first truck', progress: 0.0 },
];
