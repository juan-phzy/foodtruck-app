    ...
    menu: [
      {
        ...
        items: [
          {
            name: "BBQ Pork Ribs",
            description: "Slow-cooked pork ribs glazed with a smoky BBQ sauce.",
            price: 14.99,
            imageUrl:
    ...
    menu: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: "Chickpeas, avocado, cucumber, and lime dressing.",
            price: 8.99,
            imageUrl:
        ...
        items: [
          {
            ...
            description: "Falafel, hummus, lettuce, and tomato in a soft wrap.",
            price: 7.99,
            imageUrl:
          ...
          },
          {
            ...
            description: "Grilled tofu, spicy mayo, and fresh veggies.",
            price: 8.49,
            imageUrl:
        ...
        items: [
          {
            ...
            description: "Filled with creamy Nutella and fresh banana slices.",
            price: 7.99,
            imageUrl:
        ...
        items: [
          {
            ...
            description: "Filled with smoked ham and melted Swiss cheese.",
            price: 9.99,
            imageUrl:
    ...
    menu: [
      {
        ...
        items: [
          {
            name: "Shrimp Har Gow",
            description: "Delicate steamed dumplings with shrimp filling.",
            price: 9.99,
            imageUrl:
          ...
          {
            name: "Char Siu Bao",
            description: "Steamed buns filled with sweet barbecue pork.",
            price: 7.99,
            imageUrl:
      ...
      },
      {
        ...
        items: [
          {
            name: "Egg Tarts",
            description: "Sweet custard tarts with a flaky pastry crust.",
            price: 5.99,
            imageUrl:
          ...
          {
            name: "Sesame Balls",
            description: "Crispy fried balls filled with sweet red bean paste.",
            price: 6.49,
            imageUrl:
